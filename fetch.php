...
if (isset ($_POST["search"]["value"])) {
    $query .= 'WHERE first_name LIKE "%'.$_POST["search"]['value'].'" OR last_name LIKE "%'.$_POST["search"]["value"].'%"';
}
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $sub_array[] = '<button class="btn btn-danger btn-xs delete" data-id="'.$row['id'].'" > Delete </button>';
    $data[] = $sub_array;
}
